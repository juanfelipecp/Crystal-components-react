...
const FormModal = () => {
    ...
    const onSubmit  = async (e) =>{
        e.preventDefault()
        const {imagen, nombre, link} = formulario
        if ( imagen== ''|| nombre == ''||link == '' ){

        }
        else{
           await clienteAxios.post('/redes', {imagen, nombre, link})
           history.push('/admin')
        ...
        <div>
            <div class="content">
                <form onSubmit={onSubmit}>
                    <div class="field">
                        <label class=" negro">imagen</label>
                        <div class="control has-icons-left has-icons-right">
                            <input class="input" type="text" placeholder="imagen" name="imagen" onChange={onChange} />
